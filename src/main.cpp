...
//  float read_A_shunt() { return (1);}
//    auto* RshuntAResistance =
//      new RepeatSensor<float>(1000, read_A_shunt);
//        ->connect_to(new Linear(1.0, 0.0, "/Battery A/Shunt Resistance")) 
//          ->connect_to(new LambdaConsumer<float>([](float AshuntR) {
//        RshuntA = AshuntR;
//        }));
